        ...
        <div>
            <nav className="menu">
                ...
                <ol className='menu__content'>
                    <li className="menu-item"><a href="#0">Criar Armazém</a></li>
                    <li className="menu-item"><a href="#0">Editar Armazém</a></li>
                    <li className="menu-item"><a href="#0">Deletar Armazém</a></li>
                    <li className="menu-item">
                    <a href="#0">Configurações</a>
                    <ol className="sub-menu">
                        <li className="menu-item"><a href="#0">Consultar Conta</a></li>
                        <li className="menu-item"><a href="#0">Logout</a></li>
                    </ol>
                    </li>
                </ol>
            </nav>
